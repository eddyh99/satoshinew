            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item me-0 me-xl-4 <?= (current_url() === BASE_URL('index.php/homepage/hotdeals')) ? 'active' : '' ?>">
                        <a class="nav-link" translate="no" aria-current="page" href="<?=BASE_URL?>homepage/hotdeals">HOT DEAL</a>
                    </li>
                    <li class="nav-item me-0 me-xl-4  <?= (current_url() === BASE_URL('index.php/homepage/secret_formula')) ? 'active' : '' ?>">
                        <a class="nav-link" translate="no" aria-current="page" href="<?=BASE_URL?>homepage/secret_formula">SECRET FORMULA</a>
                    </li>
                    <li class="nav-item nav-giveaway me-0 me-xl-4  <?= (current_url() === BASE_URL('index.php/homepage/giveaway')) ? 'active' : '' ?>">
                        <a class="nav-link" translate="no" aria-current="page" href="<?=BASE_URL?>homepage/giveaway">GIVEAWAY</a>
                    </li>
                    <li class="nav-item me-0 me-xl-0">
                        <a class="nav-link" translate="no" href="<?=BASE_URL?>?type=service">CONTACTS</a>
                    </li>
