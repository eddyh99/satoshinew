        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item me-0 me-xl-2">
                        <a class="nav-link" href="<?=BASE_URL?>?type=service">CONTACT US</a>
                    </li>
                    ...
                    <li class="nav-item mt-2 mt-lg-0 d-flex align-items-center justify-content-center">
                        <a class="btn-navbar-referral btn-navbar-contactform text-center" href="<?= BASE_URL ?>referral/auth/signin">REFERRAL <span class="d-block">LOGIN</span></a>
                    </li>
                </ul>
            </div>
        </div>
